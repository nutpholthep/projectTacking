...
$order = 1;
$actN = 1;
$sql = "SELECT MAX(emp_uid) as max_id FROM employees";
$max_uid = $con->query($sql);
$number = 1;
$max_ids= $max_uid->fetch_assoc();
$pattern = "6%05d";
$next_pattern_number = intval(substr($max_ids['max_id'], 1)) + 1; // ดึงเลขส่วนเติมของรหัส Pattern ล่าสุดและเพิ่มขึ้นหนึ่ง
$next_pattern = sprintf($pattern,$next_pattern_number);
echo ($next_pattern );
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">ดูรายละเอียดการเพิ่มสมาชิก</h3>
                                    </div>

                                    <div class="card-body">
                                        <form class="needs-validation"  action="empQuery.php" method="post" novalidate>
                                            <input type="hidden" name="pattern" value="<?php echo $next_pattern ?>">
                                            <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-primary" type="submit" name="emp_submit">Submit form</button>
                                            </div>
                                        </form>
